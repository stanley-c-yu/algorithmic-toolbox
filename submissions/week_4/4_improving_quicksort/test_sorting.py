...
#        self.assertEqual(result, [1, 12, 12, 16, 88, 88, 88, 88, 88])
    ...
    def test_partition_pivot_is_2(self): 
        ...
        result = partition(arr = [2, 3, 9, 2, 2], l = 0, r = 4, index = False)
    ...
    def test_partition_pivot_is_3(self):
        ...
        result = partition(arr = [3, 2, 9, 2, 2], l = 0, r = 4, index = False)
        self.assertEqual(result, [2, 2, 2, 3, 9])
    ...
    def test_partition_pivot_is_9(self):
        ...
        result = partition(arr = [9, 3, 2, 2, 2], l = 0, r = 4, index = False)
    ...
    def test_partition_pivot_is_1(self): 
        ...
        result = partition(arr = [1, 0, 2, 0, 2, 1, 1], l = 0, r = 6, index = False)
    ...
    def test_partition_pivot_is_0(self):
        ...
        result = partition(arr = [0, 1, 2, 0, 2, 1, 1], l = 0, r = 6, index = False)
    ...
    def test_partition_index_return_pivot_is_2(self):
        ...
        result = partition(arr = [2, 3, 9, 2, 2], l = 0, r = 4, index = True)
    ...
    def test_partition_index_return_pivot_is_3(self):
        ...
        result = partition(arr = [3, 2, 9, 2, 2], l = 0, r = 4, index = True)
    ...
    def test_partition_index_return_pivot_is_9(self):
        ...
        result = partition(arr = [9, 3, 2, 2, 2], l = 0, r = 4, index = True)
    ...
    def test_partition_index_return_pivot_is_0(self):
        ...
        result = partition(arr = [0, 1, 2, 0, 2, 1, 1], l = 0, r = 6, index = True)
